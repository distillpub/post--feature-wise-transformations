function buildFigure () {
    function styleFigure () {
        ...
        var svg = d3.select("div.figure#rl-diagram").select("svg");
    ...
    d3.xml("assets/rl.svg").mimeType("image/svg+xml").get(function(error, xml) {
        if (error) throw error;
        d3.select("div.figure#rl-diagram").each(function () {
